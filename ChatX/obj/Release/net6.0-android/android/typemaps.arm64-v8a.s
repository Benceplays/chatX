...
map_modules:
	...
	.byte	0xef, 0xe0, 0xc0, 0xbc, 0xd5, 0x27, 0xab, 0x40, 0xba, 0x7c, 0x18, 0xb5, 0x85, 0xa1, 0x1, 0xab	// module_uuid: bcc0e0ef-27d5-40ab-ba7c-18b585a101ab
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module32_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.32	// assembly_name: ChatX
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
...
map_java:
	...
	.word	0x200000e	// type_token_id
	.ascii	"crc64c7cce395d69d5c6e/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x20	// module_index
	.word	0x200000f	// type_token_id
	.ascii	"crc64c7cce395d69d5c6e/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
